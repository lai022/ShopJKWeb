 ...
 * @author Siu Kit
 */
public class ProcessStaffProfile2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(pwd == 0 && digit == 0){
                String encrypted = ProcessStaffProfile2.encrypt(password);
                ...
                response.sendRedirect("secureAdmin/UpdateStaff2.jsp");
                ...
                response.sendRedirect("secureAdmin/UpdateError4.jsp");
            }
