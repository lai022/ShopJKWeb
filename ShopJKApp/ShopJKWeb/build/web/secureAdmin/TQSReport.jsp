...
<% List<Integer> cQty = (List<Integer>) session.getAttribute("cQty");%>
...
<html>
    <head>
        ...
        <title>Total Quantity Sales Report</title>
    </head>
    <body>
        <h1 style="text-align:center;margin-top: 3%;">Total Quantity Sales Report</h1>
