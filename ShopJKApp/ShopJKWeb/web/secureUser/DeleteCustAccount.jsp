<%-- 
    Document   : DeleteCustAccount
    Created on : Mar 26, 2022, 10:27:36 PM
    Author     : Siu Kit
--%>
...
<html>
    ...
    <body>
        ...
        <form action="../ProcessDeleteCustomer" method="POST" >
            <table border="1" align="center">
               ...
               <tr>
                    ...
                    <input type="hidden" name="deleteCustUserName" value="<%= login.getCustusername() %>"> 
                </tr>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <td><button type="button" id="cancel-btn" onclick="location.href='CustomerProfile.jsp' " style="width: 100%; text-decoration:none; color:black">Cancel</button></td>
                    </tr>
